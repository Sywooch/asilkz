...
<!--                    </li>-->
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?=Url::to(['/store/admin/category'])?>">Категории <i class="badge"><?=\app\modules\store\models\Category::getCount()?></i></a>
                    </li>
                    <li>
                        <a href="<?=Url::to(['/store/admin/manufacturer'])?>">Производители <i class="badge"><?=\app\modules\store\models\Manufacturer::getCount()?></i></a>
                    </li>
                    <li>
                        <a href="<?=Url::to(['/store/admin/product'])?>">Товары <i class="badge"><?=\app\modules\store\models\Product::getCount()?></i></a>
                    </li>
                    <li>
